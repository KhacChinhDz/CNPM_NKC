            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4" style="background: #0000002e;">
                    	 <h1 class="text-uppercase text-white font-weight-bold">Phòng</h1>
							...
							<div class="card-body">	
									<form action="index.php?page=list" id="filter" method="POST">
			        					<div class="row">
			        						...
			        						<div class="col-md-3">
			        							<br>
			        							<button class="btn-btn-block btn-primary mt-3">Sẵn sàng kiểm tra</button>
			        						</div>
						...
						<div class="card item-rooms mb-3">
							<div class="card-body">
								...
								<div class="col-md-5" height="100%">
									<h3><b><?php echo number_format($cat_arr[$row['category_id']]['price']) . " VNĐ"?></b><span> / mỗi ngày</span></h3>

									<h4><b>
										<?php echo $cat_arr[$row['category_id']]['name'] ?>
									</b></h4>
									<div class="align-self-end mt-5">
										<button class="btn btn-primary  float-right book_now" type="button" data-id="<?php echo $row['category_id'] ?>">Đặt ngay</button>
									</div>
								</div>
							</div>
