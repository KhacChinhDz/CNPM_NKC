...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-primary btn-sm" id="new_folder"><i class="fa fa-plus"></i> Folder mới</button>
			<button class="btn btn-primary btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> Tải File</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card-body">
					<table width="100%">
						<tr>
							...
							<th width="20%" class="">Ngày</th>
							<th width="40%" class="">Mô tả</th>
						</tr>
						<?php 
...
<div id="menu-folder-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit">Sửa tên</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option delete">Xóa</a>
</div>
<div id="menu-file-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit"><span><i class="fa fa-edit"></i> </span>Đổi tên</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option download"><span><i class="fa fa-download"></i> </span>Tải xuống</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option delete"><span><i class="fa fa-trash"></i> </span>Xóa</a>
</div>
...
//FILE
	...
	function delete_folder($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast("Đã xóa thành công.",'success')
						setTimeout(function(){
							location.reload()
						},1500)
				}
